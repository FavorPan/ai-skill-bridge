...
- **Naming:** Directory name = skill name. Use kebab-case (e.g., `cross-tool-skills`)
...
- **Naming:** Filename = command name. Use kebab-case (e.g., `cross-tool-skills.md` → `/cross-tool-skills`)
...
- **Usage patterns:**
  - Tell Codex: "先读 ~/.codex/skills/cross-tool-skills.md，然后按规范做"
  - Or add to project `AGENTS.md`: `For skill porting, read ~/.codex/skills/cross-tool-skills.md`
...
- **Usage patterns:**
  - Add to SOUL.md: `For skill porting rules, read ~/.openclaw/skills/cross-tool-skills.md`
  - Or tell OpenClaw: "先读 cross-tool-skills.md，然后按规范做"
